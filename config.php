...
function getAgentKeys(){
    ...
    return json_encode(['inline_keyboard'=>[
        [['text'=>$boughtAccounts,'callback_data'=>"saosaoch"],['text'=>$buttonValues['agent_bought_accounts'],'callback_data'=>"saosaoch"]],
        [['text'=>$joinedDate,'callback_data'=>"saosaoch"],['text'=>$buttonValues['agent_joined_date'],'callback_data'=>"saosaoch"]],
        [['text'=>$agencyDate,'callback_data'=>"saosaoch"],['text'=>$buttonValues['agent_agency_date'],'callback_data'=>"saosaoch"]],
...
function getRejectedAgentList(){
    ...
    if($list->num_rows>0){
        $keys = array();
        $keys[] = [['text'=>"آزاد ساختن",'callback_data'=>"saosaoch"],['text'=>"اسم کاربر",'callback_data'=>'saosaoch'],['text'=>"آیدی عددی",'callback_data'=>"saosaoch"]];
        while($row = $list->fetch_assoc()){
            ...
            $keys[] = [['text'=>"✅",'callback_data'=>"releaseRejectedAgent" . $userId],['text'=>$fullName,'callback_data'=>"saosaoch"],['text'=>$userId,'callback_data'=>"saosaoch"]];
        }
...
function getAgentDetails($userId){
    ...
    return json_encode(['inline_keyboard'=>[
        [
            ['text'=>"(" . $todayIncome['count'] . ") " . number_format($todayIncome['total']),'callback_data'=>'saosaoch'],
            ['text'=>"درآمد امروز",'callback_data'=>'saosaoch']
            ],
        [
            ['text'=>"(" . $yesterdayIncome['count'] . ") " . number_format($yesterdayIncome['total']),'callback_data'=>"saosaoch"],
            ['text'=>"درآمد دیروز",'callback_data'=>"saosaoch"]
            ],
        [
            ['text'=>"(" . $lastWeekIncome['count'] . ") " . number_format($lastWeekIncome['total']),'callback_data'=>"saosaoch"],
            ['text'=>"درآمد یک هفته",'callback_data'=>"saosaoch"]
            ],
        [
            ['text'=>"(" . $lastMonthIncome['count'] . ") " . number_format($lastMonthIncome['total']),'callback_data'=>"saosaoch"],
            ['text'=>"درآمد یک ماه",'callback_data'=>"saosaoch"]
            ],
...
function getAgentsList($offset = 0){
    ...
    $keys[] = [['text'=>"حذف",'callback_data'=>"saosaoch"],['text'=>"درصد تخفیف",'callback_data'=>"saosaoch"],['text'=>"تاریخ نمایندگی",'callback_data'=>"saosaoch"],['text'=>"اسم نماینده",'callback_data'=>"saosaoch"],['text'=>"آیدی عددی",'callback_data'=>"saosaoch"]];
    if($agentList->num_rows > 0){
        while($row = $agentList->fetch_assoc()){
            ...
            $keys[] = [['text'=>"❌",'callback_data'=>"removeAgent" . $userId],['text'=>"⚙️",'callback_data'=>"agentPercentDetails" . $userId],['text'=>$joinedDate,'callback_data'=>"saosaoch"],['text'=>$fullName,'callback_data'=>"agentDetails" . $userId],['text'=>$userId,'callback_data'=>"agentDetails" . $userId]];
        }
    }
...
function getAgentDiscounts($agentId){
    ...
    $keys[] = [['text'=>" ",'callback_data'=>"saosaoch"],
    ['text'=>$normal . "%",'callback_data'=>"editAgentDiscountNormal" . $agentId . "_0"],
    ['text'=>"عمومی",'callback_data'=>"saosaoch"]];            
    ...
    if($botState['agencyPlanDiscount']=="on"){
        foreach($discounts['plans'] as $planId=>$discount){
            ...
            ['text'=>$info['title'] . " " . $catInfo['title'],'callback_data'=>"saosaoch"]];            
        }
    }else{
        foreach($discounts['servers'] as $serverId=>$discount){
            ...
            ['text'=>$info['title'],'callback_data'=>"saosaoch"]];            
        }                
    }
...
function getServerConfigKeys($serverId,$offset = 0){
    ...
    return json_encode(['inline_keyboard'=>[
        [
            ['text'=>$panelUrl,'callback_data'=>"saosaoch"],
            ],
        [
            ['text'=>$cname,'callback_data'=>"editServerName$id"],
            ['text'=>"❕نام سرور",'callback_data'=>"saosaoch"]
            ],
        [
            ['text'=>$flagsaosao,'callback_data'=>"editServerFlag$id"],
            ['text'=>"🚩 پرچم سرور",'callback_data'=>"saosaoch"]
            ],
        [
            ['text'=>$remarksaosao,'callback_data'=>"editServerRemark$id"],
            ['text'=>"📣 ریمارک سرور",'callback_data'=>"saosaoch"]
            ],
        [
            ['text'=>$serverType??" ",'callback_data'=>"changeServerType$id"],
            ['text'=>"نوعیت سرور",'callback_data'=>"saosaoch"]
            ],
        [
            ['text'=>$portType,'callback_data'=>"changePortType$id"],
            ['text'=>"نوعیت پورت",'callback_data'=>"saosaoch"]
            ],
        [
            ['text'=>$ucount,'callback_data'=>"editServerMax$id"],
            ['text'=>"ظرفیت سرور",'callback_data'=>"saosaoch"]
            ],
        [
            ['text'=>$sni,'callback_data'=>"editsServersni$id"],
            ['text'=>"sni",'callback_data'=>"saosaoch"],
            ],
        [
            ['text'=>$headerType,'callback_data'=>"editsServerheader_type$id"],
            ['text'=>"header type",'callback_data'=>"saosaoch"],
            ],
        [
            ['text'=>$requestHeader,'callback_data'=>"editsServerrequest_header$id"],
            ['text'=>"request header",'callback_data'=>"saosaoch"],
            ],
        [
            ['text'=>$responseHeader,'callback_data'=>"editsServerresponse_header$id"],
            ['text'=>"response header",'callback_data'=>"saosaoch"],
            ],
        [
            ['text'=>$security,'callback_data'=>"editsServersecurity$id"],
            ['text'=>"security",'callback_data'=>"saosaoch"],
            ],
        (($serverConfig['type'] == "sanaei" || $serverConfig['type'] == "alireza")?
        [
            ['text'=>$reality,'callback_data'=>"changeRealityState$id"],
            ['text'=>"reality",'callback_data'=>"saosaoch"],
            ]:[]),
        [
        ...
        [
            ['text'=>"✂️ حذف سرور",'callback_data'=>"saosaodeleteserver$id"],
            ],
...
function getServerListKeys($offset = 0){
    ...
    $keys = array();
    $keys[] = [['text'=>"وضعیت",'callback_data'=>"saosaoch"],['text'=>"تنظیمات",'callback_data'=>"saosaoch"],['text'=>"نوعیت",'callback_data'=>"saosaoch"],['text'=>"سرور",'callback_data'=>"saosaoch"]];
    if($cats->num_rows == 0){
        $keys[] = [['text'=>"سروری یافت نشد",'callback_data'=>"saosaoch"]];
    }else {
        while($cty = $cats->fetch_assoc()){
            ...
            $keys[] = [['text'=>$state,'callback_data'=>'toggleServerState' . $id . "_" . $offset],['text'=>"⚙️",'callback_data'=>"showServerSettings" . $id . "_" . $offset],['text'=>$serverType??" ",'callback_data'=>"saosaoch"],['text'=>$cname,'callback_data'=>"saosaoch"]];
        } 
    }
...
function getCategoriesKeys($offset = 0){
    ...
    $keys = array();
    $keys[] = [['text'=>"حذف",'callback_data'=>"saosaoch"],['text'=>"اسم دسته",'callback_data'=>"saosaoch"]];
    if($cats->num_rows == 0){
        $keys[] = [['text'=>"دسته بندی یافت نشد",'callback_data'=>"saosaoch"]];
    }else {
        while($cty = $cats->fetch_assoc()){
            $id = $cty['id'];
            $cname = $cty['title'];
            $keys[] = [['text'=>"❌",'callback_data'=>"saosaocategorydelete$id" . "_" . $offset],['text'=>$cname,'callback_data'=>"saosaocategoryedit$id" . "_" . $offset]];
        }
    }
...
function getBotReportKeys(){
    ...
    return json_encode(['inline_keyboard'=>[
        [
            ['text'=>$allUsers,'callback_data'=>'saosaoch'],
            ['text'=>"تعداد کل کاربران",'callback_data'=>'saosaoch']
            ],
        [
            ['text'=>$allOrders,'callback_data'=>'saosaoch'],
            ['text'=>"کل محصولات خریداری شده",'callback_data'=>'saosaoch']
            ],
        [
            ['text'=>$allServers,'callback_data'=>'saosaoch'],
            ['text'=>"تعداد سرورها",'callback_data'=>'saosaoch']
            ],
        [
            ['text'=>$allCategories,'callback_data'=>'saosaoch'],
            ['text'=>"تعداد دسته ها",'callback_data'=>'saosaoch']
            ],
        [
            ['text'=>$allPlans,'callback_data'=>'saosaoch'],
            ['text'=>"تعداد پلن ها",'callback_data'=>'saosaoch']
            ],
        [
            ['text'=>$totalRewards,'callback_data'=>'saosaoch'],
            ['text'=>"درآمد کل",'callback_data'=>'saosaoch']
            ],
        [
            ['text'=>$dayReward,'callback_data'=>'saosaoch'],
            ['text'=>"درآمد امروز",'callback_data'=>'saosaoch']
            ],
        [
            ['text'=>$weekReward,'callback_data'=>'saosaoch'],
            ['text'=>"درآمد هفته",'callback_data'=>'saosaoch']
            ],
        [
            ['text'=>$monthReward,'callback_data'=>'saosaoch'],
            ['text'=>"درآمد ماه",'callback_data'=>'saosaoch']
            ],
        [
...
function getAdminsKeys(){
    ...
    if($usersList->num_rows > 0){
        while($user = $usersList->fetch_assoc()){
            $keys[] = [['text'=>"❌",'callback_data'=>"delAdmin" . $user['userid']],['text'=>$user['name'], "callback_data"=>"saosaoch"]];
        }
    }else{
        $keys[] = [['text'=>"لیست ادمین ها خالی است ❕",'callback_data'=>"saosaoch"]];
    }
    ...
    if($userCount->num_rows > 0){
        ...
        return json_encode(['inline_keyboard'=>[
            [
                ...
                ['text'=>"یوزرنیم",'callback_data'=>"saosaoch"]
                ],
            [
                ['text'=>$fullName??" ",'callback_data'=>"saosaoch"],
                ['text'=>"نام",'callback_data'=>"saosaoch"]
                ],
            [
                ['text'=>$boughtService??" ",'callback_data'=>"saosaoch"],
                ['text'=>"سرویس ها",'callback_data'=>"saosaoch"]
                ],
            [
                ['text'=>$totalBoughtPrice??" ",'callback_data'=>"saosaoch"],
                ['text'=>"مبلغ خرید",'callback_data'=>"saosaoch"]
                ],
            [
                ['text'=>$userWallet??" ",'callback_data'=>"saosaoch"],
                ['text'=>"موجودی کیف پول",'callback_data'=>"saosaoch"]
                ],
            [
...
function getDiscountCodeKeys(){
    ...
    $keys = array();
    if($list->num_rows > 0){
        $keys[] = [['text'=>'حذف','callback_data'=>"saosaoch"],['text'=>"استفاده هر یوزر",'callback_data'=>"saosaoch"],['text'=>"تاریخ ختم",'callback_data'=>"saosaoch"],['text'=>"تعداد استفاده",'callback_data'=>"saosaoch"],['text'=>"مقدار تخفیف",'callback_data'=>"saosaoch"],['text'=>"کد تخفیف",'callback_data'=>"saosaoch"]];
        while($row = $list->fetch_assoc()){
            ...
            $keys[] = [['text'=>'❌','callback_data'=>"delDiscount" . $rowId],['text'=>$canUse, 'callback_data'=>"saosaoch"],['text'=>$date,'callback_data'=>"saosaoch"],['text'=>$count,'callback_data'=>"saosaoch"],['text'=>$amount,'callback_data'=>"saosaoch"],['text'=>$hashId,'callback_data'=>'copyHash' . $hashId]];
        }
    }else{
        $keys[] = [['text'=>"کد تخفیفی یافت نشد",'callback_data'=>"saosaoch"]];
    }
    ...
    if($buttons->num_rows > 0){
        while($row = $buttons->fetch_assoc()){
            ...
            $keys[] = [
                        ...
                        ['text'=>$title??" " ,'callback_data'=>"saosaoch"]];
        }
    }else{
        $keys[] = [['text'=>"دکمه ای یافت نشد ❕",'callback_data'=>"saosaoch"]];
    }
...
function getPlanDetailsKeys($planId){
    ...
    if($pdResult->num_rows == 0) return null;
        ...
        $stmt->bind_param("i", $id);
        $stmt->execute();
        $saosaoplanaccnumber = $stmt->get_result()->num_rows;
        $stmt->close();

        $srvid= $pd['server_id'];
        $keyboard = [
            ($rahgozar==true?[['text'=>"* نوع پلن: رهگذر *",'callback_data'=>'saosaoch']]:[]),
            ($rahgozar==true?[
                ['text'=>$customPath,'callback_data'=>'changeCustomPath' . $id],
                ['text'=>"Path Custom",'callback_data'=>'saosaoch'],
                ]:[]),
            ($rahgozar==true?[
                ['text'=>$customPort,'callback_data'=>'changeCustomPort' . $id],
                ['text'=>"پورت دلخواه",'callback_data'=>'saosaoch'],
                ]:[]),
            ($rahgozar==true?[
                ['text'=>$customSni,'callback_data'=>'changeCustomSni' . $id],
                ['text'=>"sni دلخواه",'callback_data'=>'saosaoch'],
                ]:[]),
            [['text'=>$name,'callback_data'=>"saosaoplanname$id"],['text'=>"🔮 نام پلن",'callback_data'=>"saosaoch"]],
            ($reality == "true"?[['text'=>$dest,'callback_data'=>"editDestName$id"],['text'=>"dest",'callback_data'=>"saosaoch"]]:[]),
            ($reality == "true"?[['text'=>$serverName,'callback_data'=>"editServerNames$id"],['text'=>"serverNames",'callback_data'=>"saosaoch"]]:[]),
            ($reality == "true"?[['text'=>$spiderX,'callback_data'=>"editSpiderX$id"],['text'=>"spiderX",'callback_data'=>"saosaoch"]]:[]),
            ($reality == "true"?[['text'=>$flow,'callback_data'=>"editFlow$id"],['text'=>"flow",'callback_data'=>"saosaoch"]]:[]),
            [['text'=>$saosaoplanaccnumber,'callback_data'=>"saosaoch"],['text'=>"🎗 تعداد اکانت های فروخته شده",'callback_data'=>"saosaoch"]],
            ($pd['inbound_id'] != 0?[['text'=>"$acount",'callback_data'=>"saosaoplanslimit$id"],['text'=>"🚪 تغییر ظرفیت کانفیگ",'callback_data'=>"saosaoch"]]:[]),
            ($pd['inbound_id'] != 0?[['text'=>$pd['inbound_id'],'callback_data'=>"saosaoplansinobundid$id"],['text'=>"🚪 سطر کانفیگ",'callback_data'=>"saosaoch"]]:[]),
            [['text'=>"✏️ ویرایش توضیحات",'callback_data'=>"saosaoplaneditdes$id"]],
            [['text'=>number_format($price) . " تومان",'callback_data'=>"saosaoplanrial$id"],['text'=>"💰 قیمت پلن",'callback_data'=>"saosaoch"]],
            [['text'=>"♻️ دریافت لیست اکانت ها",'callback_data'=>"saosaoplanacclist$id"]],
            [['text'=>"✂️ حذف",'callback_data'=>"saosaoplandelete$id"]],
        ...
        if($inbound_id == 0){
            if($protocol == 'trojan') {
                if($security == "xtls"){
                    $keyboard = [
                        [
            			    ['text' => $userId, 'callback_data' => "saosaoch"],
                            ['text' => "آیدی کاربر", 'callback_data' => "saosaoch"],
                        ],
                        [
            			    ['text' => $firstName, 'callback_data' => "saosaoch"],
                            ['text' => "اسم کاربر", 'callback_data' => "saosaoch"],
                        ],
                        [
            			    ['text' => $isAgentBought, 'callback_data' => "saosaoch"],
                            ['text' => "خرید نماینده", 'callback_data' => "saosaoch"],
                        ],
                        [
            			    ['text' => "$name", 'callback_data' => "saosaoch"],
                            ['text' => $buttonValues['plan_name'], 'callback_data' => "saosaoch"],
                        ],
                        [
            			    ['text' => "$date ", 'callback_data' => "saosaoch"],
                            ['text' => $buttonValues['buy_date'], 'callback_data' => "saosaoch"],
                        ],
                        [
            			    ['text' => "$expire_date ", 'callback_data' => "saosaoch"],
                            ['text' => $buttonValues['expire_date'], 'callback_data' => "saosaoch"],
                        ],
                        [
            			    ['text' => " $leftgb", 'callback_data' => "saosaoch"],
                            ['text' => $buttonValues['volume_left'], 'callback_data' => "saosaoch"],
            			],
                        [
                            ['text' => $buttonValues['selected_protocol'], 'callback_data' => "saosaoch"],
                        ],
                        [
                            ['text' => $protocol == 'trojan' ? '☑️ trojan' : 'trojan', 'callback_data' => "saosaoch"],
                            ['text' => $protocol == 'vless' ? '☑️ vless' : 'vless', 'callback_data' => "saosaoch"],
                        ],
                        [
                    ...
                    $keyboard = [
                        ...
                        [
                            ['text' => $protocol == 'trojan' ? '☑️ trojan' : 'trojan', 'callback_data' => "saosaoch"],
                            ['text' => $protocol == 'vmess' ? '☑️ vmess' : 'vmess', 'callback_data' => "saosaoch"],
                            ['text' => $protocol == 'vless' ? '☑️ vless' : 'vless', 'callback_data' => "saosaoch"],
                        ],
                        [
                            ['text'=>($enable == true?$buttonValues['disable_config']:$buttonValues['enable_config']),'callback_data'=>"changeUserConfigState" . $order['id']],
            ...
            $keyboard = [
                ...
                [
                    ['text' => " $protocol ☑️", 'callback_data' => "saosaoch"],
                ],
                [
                    ['text'=>($enable == true?$buttonValues['disable_config']:$buttonValues['enable_config']),'callback_data'=>"changeUserConfigState" . $order['id']],
                    ['text'=>$buttonValues['delete_config'],'callback_data'=>"delUserConfig" . $order['id']],
